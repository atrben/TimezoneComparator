...
TZ_ABBREVIATIONS = {
    'US/Pacific': 'PST', 'US/Mountain': 'MST', 'US/Central': 'CST', 'US/Eastern': 'EST',
    'Europe/London': 'GMT', 'Europe/Paris': 'CET', 'Europe/Berlin': 'CET',
    'Asia/Tokyo': 'JST', 'Australia/Sydney': 'AEDT', 'America/Sao_Paulo': 'BRT',
    'Asia/Kolkata': 'IST', 'America/Argentina/Buenos_Aires': 'ART', 'Europe/Istanbul': 'TRT',
    'America/Halifax': 'AST', 'Europe/Malta': 'MT', 'Asia/Jakarta': 'WIB',
    'Pacific/Samoa': 'SST', 'Asia/Seoul': 'KST', 'America/Manaus': 'AMT',
    'Asia/Manila': 'PHT', 'Australia/Adelaide': 'ACST', 'Asia/Makassar': 'WITA',
    'America/Bogota': 'COT', 'Africa/Johannesburg': 'SAST', 'Pacific/Auckland': 'NZDT',
...
def calculate_shift():
    ...
    if timezones_str.strip():
        ...
        for line in lines:
            line = line.strip()
            if line:
                tz_entries = [tz.strip() for tz in line.split(',') if tz.strip()]
